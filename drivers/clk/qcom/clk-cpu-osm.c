...
{
	unsigned int skip_freqs_big[] = {1536000, 1612800, 1689600, 1766400, 1843200, 1920000, 2092800, 2169600, 2400000, 2553600, 2745600, 2764800, 2784000, 2803200};
	int i;
